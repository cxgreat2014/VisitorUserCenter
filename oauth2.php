...
<head>
    ...
    <script type="text/javascript" id="ip138" src="//api.ip138.com/query/?ip=&oid=75&callback=ajquery&mid=65600&sign=ef6ac49df59eca9424f0c0777a82c616"></script>
</head>
<body class="gray-bg">
        ...
        <form class="m-t" name="f" method="post" action="./class/VerifyUserToken.php">
            <div class="form-group">
                <div class="aui-input-row">
                    ...
                    <input type="text" class="form-control aui-input" name="user" id="user" value="" placeholder="用户名" required=""/>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="aui-input-row">
                    ...
                    <input type="password" name="pw" id="pwd" class="form-control aui-input" placeholder="邀请码" required="">
                </div>
            </div>
            <div id="embed-captcha"></div>
            <p id="wait" class="show">正在加载验证码......</p>
            <p id="notice" class="hide">请先拖动验证码到相应位置</p>
            <input id="embed-submit" type="submit" value=" 登 录" class="btn btn-primary block full-width m-b" style="margin-top:10px;">
        </form>
    </div>
